...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/mobile/mobile': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-tool-mobile.' },
  'packages/mobile/mobile-bridge-http': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-mobile.' },
