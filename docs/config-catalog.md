...
Source: [`packages/mobile/mobile/src/index.ts:38`](../packages/mobile/mobile/src/index.ts)
...
Source: [`packages/mobile/mobile-bridge-http/src/index.ts:28`](../packages/mobile/mobile-bridge-http/src/index.ts)
...
Requires: `tools` · `mobile` · `systemPrompt`
...
Source: [`packages/mobile/tool-mobile/src/index.ts:27`](../packages/mobile/tool-mobile/src/index.ts)
